...
def generar_caso_de_uso_evaluar_modelo():
    ...
    # Globulares: Momentos de inercia casi iguales (esferas)
    n_glob = n_muestras // 3
    globulares = {
    ...
    # Fibrosas: Un momento mucho mayor que otros (cilindros/agujas)
    n_fib = n_muestras // 3
    fibrosas = {
        ...
        'momento_x': np.random.uniform(500, 1000, n_fib), # Eje largo
    ...
    # Membrana: Dos momentos grandes y uno pequeño (discos/planos)
    ...
    membrana = {
        ...
        'momento_z': np.random.uniform(50, 100, n_memb), # Eje corto
    ...
    # 3. Definir el diccionario de entrada (Input)
    input_dict = {
        'dataset': df_input,
